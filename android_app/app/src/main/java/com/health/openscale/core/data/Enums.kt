...
enum class UserIcon(val resource: IconResource) {
    IC_DEFAULT(IconResource.VectorResource(Icons.Rounded.AccountCircle)),
    IC_MALE(IconResource.VectorResource(Icons.Rounded.Face6)),
    IC_FEMALE(IconResource.VectorResource(Icons.Rounded.Face3)),
    IC_CHILD(IconResource.VectorResource(Icons.Rounded.ChildCare)),
    IC_HAPPY_FACE(IconResource.VectorResource(Icons.Rounded.SentimentSatisfied)),
    IC_HAPPY_FACE_MOOD(IconResource.VectorResource(Icons.Rounded.Mood)),
    IC_HAPPY_FACE_ALT(IconResource.VectorResource(Icons.Rounded.SentimentVerySatisfied))

}

enum class MeasurementTypeIcon(val resource: IconResource) {
    IC_DEFAULT(IconResource.VectorResource(Icons.Rounded.QuestionMark)),
    ...
    IC_M_HEIGHT(IconResource.VectorResource(Icons.Rounded.Height)),
    IC_M_HEART_RATE(IconResource.VectorResource(Icons.Rounded.Favorite)),
    IC_M_STEPS(IconResource.VectorResource(Icons.AutoMirrored.Rounded.DirectionsWalk)),
    IC_M_SLEEP(IconResource.VectorResource(Icons.Rounded.NightsStay)),
    IC_M_WORKOUT(IconResource.VectorResource(Icons.Rounded.FitnessCenter)),
    IC_M_WATER_INTAKE(IconResource.VectorResource(Icons.Rounded.LocalDrink)),
    IC_M_GOAL(IconResource.VectorResource(Icons.Rounded.Flag)),
    IC_M_NOTES(IconResource.VectorResource(Icons.Rounded.EditNote)),
    IC_M_TEMPERATURE(IconResource.VectorResource(Icons.Rounded.DeviceThermostat)),
    IC_M_BLOOD_PRESSURE(IconResource.VectorResource(Icons.Rounded.Bloodtype)),
    IC_M_GLUCOSE(IconResource.VectorResource(Icons.Rounded.Bloodtype)),
    IC_M_TREND_UP(IconResource.VectorResource(Icons.AutoMirrored.Rounded.TrendingUp)),
    IC_M_TREND_DOWN(IconResource.VectorResource(Icons.AutoMirrored.Rounded.TrendingDown)),
    IC_M_TREND_FLAT(IconResource.VectorResource(Icons.AutoMirrored.Rounded.TrendingFlat)),
    IC_M_CALENDAR(IconResource.VectorResource(Icons.Rounded.CalendarMonth)),
    IC_M_CLOCK(IconResource.VectorResource(Icons.Rounded.Schedule)),
    IC_M_TIMER(IconResource.VectorResource(Icons.Rounded.Timer)),
    IC_M_INFO(IconResource.VectorResource(Icons.Rounded.Info)),
    IC_M_HELP(IconResource.VectorResource(Icons.AutoMirrored.Rounded.HelpOutline)),
    IC_M_SETTINGS(IconResource.VectorResource(Icons.Rounded.Settings)),
    IC_M_ADD(IconResource.VectorResource(Icons.Rounded.AddCircleOutline)),
    IC_M_REMOVE(IconResource.VectorResource(Icons.Rounded.RemoveCircleOutline)),
    IC_M_DONE(IconResource.VectorResource(Icons.Rounded.Done)),
    IC_M_CHECK_CIRCLE(IconResource.VectorResource(Icons.Rounded.CheckCircleOutline)),
    IC_M_WARNING(IconResource.VectorResource(Icons.Rounded.WarningAmber)),
    IC_M_ANALYTICS(IconResource.VectorResource(Icons.Rounded.Analytics)),
    IC_M_CHART_BAR(IconResource.VectorResource(Icons.AutoMirrored.Rounded.ShowChart)),
    IC_M_CHART_LINE(IconResource.VectorResource(Icons.Rounded.StackedLineChart)),
    IC_M_CHART_PIE(IconResource.VectorResource(Icons.Rounded.PieChart)),
    IC_M_NUTRITION(IconResource.VectorResource(Icons.Rounded.LocalDining)),
    IC_M_PROTEIN(IconResource.VectorResource(Icons.Rounded.Egg)),
    IC_M_CARBS(IconResource.VectorResource(Icons.Rounded.Grain)),
    IC_M_FAT_FOOD(IconResource.VectorResource(Icons.Rounded.OilBarrel)),
    IC_M_SPEED(IconResource.VectorResource(Icons.Rounded.Speed)),
    IC_M_DISTANCE(IconResource.VectorResource(Icons.Rounded.SquareFoot)),
    IC_M_MOOD(IconResource.VectorResource(Icons.Rounded.SentimentSatisfiedAlt)),
    IC_M_MEDICATION(IconResource.VectorResource(Icons.Rounded.Medication)),
    IC_M_LIST(IconResource.VectorResource(Icons.AutoMirrored.Rounded.List)),
    IC_M_LABEL(IconResource.VectorResource(Icons.AutoMirrored.Rounded.Label)),
    IC_M_PERSON(IconResource.VectorResource(Icons.Rounded.Person));
}
